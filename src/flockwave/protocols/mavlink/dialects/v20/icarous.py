...
class MAVLink_icarous_heartbeat_message(MAVLink_message):
    ...
    def __init__(self, status: int):
        MAVLink_message.__init__(
            self,
            MAVLink_icarous_heartbeat_message.id,
            MAVLink_icarous_heartbeat_message.msgname,
        )
    ...
    def pack(self, mav: "MAVLink", force_mavlink1: bool = False) -> bytes:
        return self._pack(
            mav,
            self.crc_extra,
            self.unpacker.pack(self.status),
...
setattr(
    MAVLink_icarous_heartbeat_message, "name", mavlink_msg_deprecated_name_property()
)
...
class MAVLink_icarous_kinematic_bands_message(MAVLink_message):
    ...
    def __init__(
        ...
        MAVLink_message.__init__(
            self,
            MAVLink_icarous_kinematic_bands_message.id,
            MAVLink_icarous_kinematic_bands_message.msgname,
        )
...
# Done with setattr to hide the class variable from mypy.
setattr(
    MAVLink_icarous_kinematic_bands_message,
    "name",
    mavlink_msg_deprecated_name_property(),
)
...
class MAVLink(object):
    ...
    def icarous_heartbeat_encode(
        self, status: int
    ) -> MAVLink_icarous_heartbeat_message:
        """
        ICAROUS heartbeat
    ...
    def icarous_kinematic_bands_encode(
        self,
        numBands: int,
        type1: int,
        min1: float,
        ...
        """
        return MAVLink_icarous_kinematic_bands_message(
            numBands,
            type1,
            min1,
            max1,
    ...
    def icarous_kinematic_bands_send(
        self,
        numBands: int,
        type1: int,
        min1: float,
        ...
        """
        self.send(
            self.icarous_kinematic_bands_encode(
                numBands,
                type1,
                min1,
                max1,
