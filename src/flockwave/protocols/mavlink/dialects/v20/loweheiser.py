...
enums["MAV_CMD"][10151] = EnumEntry(
    "MAV_CMD_LOWEHEISER_SET_STATE", """Set Loweheiser desired states"""
)
enums["MAV_CMD"][10151].param[1] = """EFI Index"""
enums["MAV_CMD"][10151].param[2] = (
    """Desired Engine/EFI State (0: Power Off, 1:Running)"""
)
enums["MAV_CMD"][10151].param[3] = (
...
enums["MAV_AUTOPILOT"][20] = EnumEntry(
...
enums["MAV_COMPONENT"][161] = EnumEntry(
...
enums["MAV_COMPONENT"][189] = EnumEntry(
...
class MAVLink_loweheiser_gov_efi_message(MAVLink_message):
    ...
    fieldunits_by_name: Dict[str, str] = {
        ...
        "efi_clt": "degC",
        "efi_tps": "%",
        "efi_exhaust_gas_temperature": "degC",
    }
    ...
    def __init__(
        ...
        throttle: float,
        runtime: int,
        until_maintenance: int,
        rectifier_temp: float,
        generator_temp: float,
        efi_batt: float,
        efi_rpm: float,
        efi_pw: float,
        efi_fuel_flow: float,
        efi_fuel_consumed: float,
        efi_baro: float,
        efi_mat: float,
        efi_clt: float,
        efi_tps: float,
        efi_exhaust_gas_temperature: float,
        efi_index: int,
        ...
        MAVLink_message.__init__(
            self,
            MAVLink_loweheiser_gov_efi_message.id,
            MAVLink_loweheiser_gov_efi_message.msgname,
        )
    ...
    def pack(self, mav: "MAVLink", force_mavlink1: bool = False) -> bytes:
        return self._pack(
            ...
            self.unpacker.pack(
                ...
                self.efi_pw,
                self.efi_fuel_flow,
                self.efi_fuel_consumed,
                self.efi_baro,
                self.efi_mat,
                self.efi_clt,
                self.efi_tps,
                self.efi_exhaust_gas_temperature,
...
setattr(
    MAVLink_loweheiser_gov_efi_message, "name", mavlink_msg_deprecated_name_property()
)
...
class MAVLink_heartbeat_message(MAVLink_message):
    ...
    def __init__(
        ...
        MAVLink_message.__init__(
            self, MAVLink_heartbeat_message.id, MAVLink_heartbeat_message.msgname
        )
...
class MAVLink(object):
    ...
    def loweheiser_gov_efi_encode(
        ...
        generator_status: int,
        efi_status: int,
    ) -> MAVLink_loweheiser_gov_efi_message:
        """
        Composite EFI and Governor data from Loweheiser equipment.  This
    ...
    def loweheiser_gov_efi_send(
        ...
        """
        self.send(
            self.loweheiser_gov_efi_encode(
                volt_batt,
                curr_batt,
                curr_gen,
                curr_rot,
