...
class MAVLink_airlink_auth_message(MAVLink_message):
    ...
    def __init__(self, login: bytes, password: bytes):
        MAVLink_message.__init__(
            self, MAVLink_airlink_auth_message.id, MAVLink_airlink_auth_message.msgname
        )
    ...
    def pack(self, mav: "MAVLink", force_mavlink1: bool = False) -> bytes:
        return self._pack(
            mav,
            self.crc_extra,
            self.unpacker.pack(self._login_raw, self._password_raw),
...
class MAVLink_airlink_auth_response_message(MAVLink_message):
    ...
    def __init__(self, resp_type: int):
        MAVLink_message.__init__(
            self,
            MAVLink_airlink_auth_response_message.id,
            MAVLink_airlink_auth_response_message.msgname,
        )
    ...
    def pack(self, mav: "MAVLink", force_mavlink1: bool = False) -> bytes:
        return self._pack(
            mav,
            self.crc_extra,
            self.unpacker.pack(self.resp_type),
            force_mavlink1=force_mavlink1,
        )
...
# Done with setattr to hide the class variable from mypy.
setattr(
    MAVLink_airlink_auth_response_message,
    "name",
    mavlink_msg_deprecated_name_property(),
)
...
class MAVLink(object):
    ...
    def airlink_auth_encode(
        self, login: bytes, password: bytes
    ) -> MAVLink_airlink_auth_message:
        """
        Authorization package
    ...
    def airlink_auth_send(
        self, login: bytes, password: bytes, force_mavlink1: bool = False
    ) -> None:
        """
        Authorization package
        ...
        """
        self.send(
            self.airlink_auth_encode(login, password), force_mavlink1=force_mavlink1
        )

    def airlink_auth_response_encode(
        self, resp_type: int
    ) -> MAVLink_airlink_auth_response_message:
        """
        Response to the authorization request
    ...
    def airlink_auth_response_send(
        self, resp_type: int, force_mavlink1: bool = False
    ) -> None:
        """
        Response to the authorization request
        ...
        """
        self.send(
            self.airlink_auth_response_encode(resp_type), force_mavlink1=force_mavlink1
        )
